...
window.D2DOCS = {
  ...
  cms: {
    ...
    attrs: [
      { g: "Lista (Collection List)", a: 'd2-cms-list', v: 'nazwa', el: 'Collection List', req: true, d: 'Rejestruje listę pod tą nazwą — punkt zaczepienia dla wszystkich kontrolek.', n: 'alias: <code>d2-cms-instance</code>' },
      { g: "Lista (Collection List)", a: 'd2-cms-per-page', v: 'liczba', el: 'Collection List', d: 'Ile itemów widać na start i ile dokłada każde doładowanie.' },
      { g: "Lista (Collection List)", a: 'd2-cms-load-mode', v: 'button | scroll | all', el: 'Collection List', d: 'Tryb doładowania: przycisk, infinite scroll (sentinel) albo wszystko od razu.' },
      { g: "Lista (Collection List)", a: 'd2-cms-scroll-offset', v: 'px', el: 'Collection List', d: 'Margines wyprzedzenia dla infinite scrolla (domyślnie 200).' },
      { g: "Lista (Collection List)", a: 'd2-cms-sort-by', v: 'pole', el: 'Collection List', d: 'Domyślne sortowanie przy załadowaniu strony.' },
      { g: "Lista (Collection List)", a: 'd2-cms-filter-match', v: 'AND | OR', el: 'Collection List', d: 'Jak łączyć różne pola filtrów (domyślnie AND; w obrębie pola zawsze OR).' },
      { g: "Lista (Collection List)", a: 'd2-cms-hidden-class', v: 'klasa', el: 'Collection List', d: 'Ukrywanie klasą CSS zamiast display:none.' },
      { g: "Lista (Collection List)", a: 'd2-cms-hide-pagination', v: 'false', el: 'Collection List', d: 'Zostawia natywną paginację Webflow widoczną (domyślnie jest chowana).' },
      { g: "Lista (Collection List)", a: 'd2-cms-group-by', v: 'pole', el: 'Collection List', d: 'Trwałe grupowanie — sortowanie użytkownika działa wewnątrz grup.' },
      { g: "Lista (Collection List)", a: 'd2-cms-group-order', v: 'a|b|c', el: 'Collection List', d: 'Kolejność grup dla group-by (np. Dostępne przed Sprzedane).' },
      { g: "Itemy i pola danych", a: 'd2-cms-item', v: '', el: 'element itemu', d: 'Jawnie oznacza itemy, gdy nie są bezpośrednimi dziećmi kontenera.' },
      { g: "Itemy i pola danych", a: 'd2-cms-field', v: 'nazwaPola', el: 'Text wewnątrz Collection Item', d: 'Tekst tego elementu staje się wartością pola do sortowania i filtrów.' },
      { g: "Itemy i pola danych", a: 'd2-cms-field-type', v: 'number | text | date', el: 'element z d2-cms-field', d: 'Wymusza typ porównywania (bez niego autodetekcja).' },
      { g: "Itemy i pola danych", a: 'd2-cms-field-*', v: 'wartość', el: 'Collection Item', d: 'Wariant inline: <code>d2-cms-field-cena="399000"</code> — pole z atrybutu zamiast ukrytego spana.', n: 'typ: <code>d2-cms-field-type-cena="number"</code>' },
      { g: "Wiązanie kontrolek z listą", a: 'd2-cms-target', v: 'nazwa lub a|b', el: 'każda kontrolka poza listą', d: 'Wskazuje, którą listą steruje element. Pipe <code>|</code> celuje w kilka list — liczniki śledzą wtedy listę widoczną (np. aktywny tab).', n: 'opcjonalny przy jednej liście na stronie' },
      { g: "Przyciski sortowania", a: 'd2-cms-sort', v: 'pole', el: 'Button / Link / opcja', d: 'Klik sortuje po polu: 1. klik rosnąco, 2. malejąco, 3. czyści.', n: 'z <code>d2-cms-sort-dir</code> kierunek jest stały' },
      { g: "Przyciski sortowania", a: 'd2-cms-sort-dir', v: 'asc | desc', el: 'lista lub przycisk sortowania', d: 'Na liście: domyślny kierunek. Na przycisku: wymusza kierunek bez przełączania.' },
      { g: "Przyciski sortowania", a: 'd2-cms-sort-type', v: 'number | text | date', el: 'przycisk sortowania', d: 'Wymusza typ porównywania dla tego pola.' },
      { g: "Przyciski sortowania", a: 'd2-cms-sort-order', v: 'a|b|c', el: 'lista lub przycisk', d: 'Własny ranking wartości (najpierw a, potem b…), zamiast alfabetu.' },
      { g: "Przyciski sortowania", a: 'd2-cms-sort-label', v: '', el: 'Text w toggle dropdownu', d: 'Moduł wpisuje tu tekst aktywnej opcji sortowania.' },
      { g: "Przyciski sortowania", a: 'd2-cms-sort-option-label', v: 'tekst', el: 'opcja sortowania', d: 'Własny tekst, który trafi do etykiety zamiast treści opcji.' },
      { g: "Przyciski sortowania", a: 'd2-cms-sort-scope', v: '', el: 'wrapper', d: 'Ogranicza, które opcje mogą aktualizować etykietę (zamiast .w-dropdown).' },
      { g: "Przyciski sortowania", a: 'd2-cms-sort-active', v: 'asc | desc', el: 'przycisk sortowania', set: true, d: 'Obecny na aktywnej opcji — hook do stylowania CSS.' },
      { g: "Przyciski sortowania", a: 'd2-cms-direction', v: 'asc | desc | toggle', el: 'Button', d: 'Zmienia kierunek aktywnego sortowania bez zmiany pola.' },
      { g: "Przyciski sortowania", a: 'd2-cms-direction-active', v: 'asc | desc', el: 'przycisk kierunku', set: true, d: 'Obecny, gdy sortowanie aktywne — hook CSS.' },
      { g: "Filtry i czyszczenie", a: 'd2-cms-filter', v: 'pole:wartość lub pole', el: 'Button / Checkbox / Radio', d: 'Przełącza filtr. Kilka wartości naraz: <code>pole:a|b</code>. Checkboxy i radio synchronizują stan zaznaczenia. Bez wartości (samo <code>pole</code>) wartość bierze się z <code>d2-cms-filter-value</code>.' },
      { g: "Filtry i czyszczenie", a: 'd2-cms-filter-value', v: 'wartość', el: 'ta sama kontrolka', d: 'Wartość filtra z osobnego, <b>bindowalnego</b> atrybutu — obejście limitu Webflow, gdy nie da się skleić <code>pole:{{Nazwa CMS}}</code> w jednym atrybucie.' },
      { g: "Filtry i czyszczenie", a: 'd2-cms-filter-default', v: '(puste) | false', el: 'kontrolka filtra', d: 'Ten filtr jest aktywny od załadowania strony (checkbox/radio też zostaje zaznaczony). <code>="false"</code> jawnie wyłącza.' },
      { g: "Filtry i czyszczenie", a: 'd2-cms-filter-field', v: 'pole', el: 'Select (Form)', d: 'Natywny select jako filtr — pusta opcja czyści.' },
      { g: "Filtry i czyszczenie", a: 'd2-cms-filter-label', v: 'pole', el: 'Text', d: 'Moduł wpisuje tu aktywną wartość filtra danego pola.' },
      { g: "Filtry i czyszczenie", a: 'd2-cms-filter-option-label', v: 'tekst', el: 'opcja filtra', d: 'Własny tekst, który opcja wnosi do etykiety filtra (zamiast swojej treści).' },
      { g: "Filtry i czyszczenie", a: 'd2-cms-filter-scope', v: '', el: 'wrapper', d: 'Ogranicza, które opcje mogą aktualizować etykietę filtra (zamiast .w-dropdown).' },
      { g: "Filtry i czyszczenie", a: 'd2-cms-filter-active', v: '', el: 'kontrolka filtra', set: true, d: 'Obecny na aktywnym filtrze — hook do stylowania.' },
      { g: "Filtry i czyszczenie", a: 'd2-cms-clear', v: 'puste | all | pole', el: 'Button / Link', d: 'Czyści filtry (puste), filtry + sortowanie (<code>all</code>) albo jedno pole.' },
      { g: "Odłożone filtrowanie (Zastosuj)", a: 'd2-cms-apply', v: '', el: 'Button', d: 'Włącza <b>odroczone filtrowanie</b>: zmiany filtrów nie przebudowują listy od razu — kumulują się jako szkic, a lista aktualizuje się dopiero po kliknięciu tego przycisku.', n: 'sama obecność przycisku przełącza listę w ten tryb' },
      { g: "Odłożone filtrowanie (Zastosuj)", a: 'd2-cms-apply-count', v: 'szablon, np. Pokaż {count}', el: 'przycisk apply', d: 'Podgląd na żywo: przycisk pokazuje, ile wyników da szkic. Token <code>{count}</code> podstawiany (bez tokenu — liczba doklejana).' },
      { g: "Odłożone filtrowanie (Zastosuj)", a: 'd2-cms-apply-empty', v: 'tekst', el: 'przycisk apply', d: 'Tekst przycisku, gdy szkic daje 0 wyników (nadpisuje wariant z count).' },
      { g: "Odłożone filtrowanie (Zastosuj)", a: 'd2-cms-apply-label', v: '', el: 'element w przycisku apply', d: 'Tylko tekst tego dziecka jest podmieniany licznikiem (reszta przycisku, np. ikona, zostaje).' },
      { g: "Odłożone filtrowanie (Zastosuj)", a: 'd2-cms-apply-pending', v: '', el: 'przycisk apply', set: true, d: 'Obecny, gdy są niezatwierdzone zmiany filtrów — hook do wyróżnienia przycisku.' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range', v: '', el: 'Div (wrapper suwaka)', d: 'Kontener dwuuchwytowego suwaka zakresu.' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-field', v: 'pole', el: 'wrapper suwaka', req: true, d: 'Które pole liczbowe filtruje suwak.' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-min', v: 'liczba', el: 'wrapper suwaka', d: 'Sztywne minimum (bez niego autodetekcja z itemów).' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-max', v: 'liczba', el: 'wrapper suwaka', d: 'Sztywne maksimum (bez niego autodetekcja).' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-default-min', v: 'liczba', el: 'wrapper suwaka', d: 'Pozycja startowa lewego uchwytu (od razu filtruje).' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-default-max', v: 'liczba', el: 'wrapper suwaka', d: 'Pozycja startowa prawego uchwytu.' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-step', v: 'liczba', el: 'wrapper suwaka', d: 'Skok dla strzałek klawiatury (domyślnie 1).' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-snap', v: '(puste) | false', el: 'wrapper suwaka', d: 'Zaokrągla auto-wykryte granice do wielokrotności kroku — min w dół, max w górę (ładne, okrągłe końce, np. 5–210 zamiast 7–207,25). Nigdy nie wyklucza itemu; ręczne min/max są nietknięte.' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-static-bounds', v: '(puste)', el: 'wrapper suwaka', d: 'Zamraża granice suwaka. Domyślnie granice liczą się z itemów przechodzących <b>filtry kategorialne</b> (taby, chipy, selecty — nigdy inne suwaki, bo dwa suwaki zawężałyby się nawzajem aż jeden zwinąłby się do martwego punktu) i przeliczają po każdej ich zmianie — wchodzisz na tab „Domy” i cena biegnie od najtańszego do najdroższego domu, a nie od najtańszego wiersza w całym CMS. Z tą flagą mierzone są raz, z całego zbioru.', n: 'własne pole suwaka jest wyłączone z pomiaru, więc przeciąganie nie przeskalowuje toru pod palcem' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-displayformat', v: 'pln | eur | usd | thousands | wzorzec', el: 'wrapper suwaka', d: 'Format wyświetlanych liczb, np. <code>pln</code> → 1 600 000.', n: 'alias: <code>d2-cms-range-format</code>; wzorzec np. <code>0,000 PLN</code>' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-prefix', v: 'tekst', el: 'wrapper suwaka', d: 'Tekst przed liczbą (np. waluta z przodu).' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-suffix', v: 'tekst', el: 'wrapper suwaka', d: 'Tekst po liczbie (np. „ zł”).' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-display', v: 'min | max', el: 'Text w suwaku', d: 'Moduł wpisuje tu bieżącą wartość uchwytu.' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-track', v: '', el: 'Div w suwaku', d: 'Tor suwaka (tło uchwytów).' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-fill', v: '', el: 'Div w torze', d: 'Wypełnienie między uchwytami (pozycjonowane przez moduł).' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-handle', v: 'min | max', el: 'Div w torze', req: true, d: 'Przeciągalny uchwyt — potrzebne oba.' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-dragging', v: '', el: 'uchwyt', set: true, d: 'Obecny podczas przeciągania — hook CSS.' },
      { g: "Suwak zakresu (od–do)", a: 'd2-cms-range-active', v: '', el: 'wrapper suwaka', set: true, d: 'Obecny, gdy filtr zakresu jest zawężony — hook CSS.' },
      { g: "Doładowywanie i liczba widocznych", a: 'd2-cms-load-more', v: '', el: 'Button', d: 'Klik dokłada kolejne <i>per-page</i> itemów.' },
      { g: "Doładowywanie i liczba widocznych", a: 'd2-cms-loadcount', v: 'liczba | all', el: 'Button', d: 'Klik dokłada konkretną liczbę itemów albo wszystkie.' },
      { g: "Doładowywanie i liczba widocznych", a: 'd2-cms-load-more-done', v: '', el: 'przycisk load-more', set: true, d: 'Moduł ustawia, gdy nie ma już czego dokładać (przycisk też znika).' },
      { g: "Doładowywanie i liczba widocznych", a: 'd2-cms-sentinel', v: 'nazwa listy', el: 'niewidoczny div', set: true, d: 'Strażnik infinite scrolla — moduł wstawia go sam za listą.' },
      { g: "Doładowywanie i liczba widocznych", a: 'd2-cms-count', v: '', el: 'Input (number)', d: 'Wpisana liczba = dokładnie tyle widocznych itemów; input odzwierciedla stan listy.' },
      { g: "Doładowywanie i liczba widocznych", a: 'd2-cms-count-min', v: 'liczba', el: 'input d2-cms-count', d: 'Dolny limit wartości (domyślnie 1).' },
      { g: "Doładowywanie i liczba widocznych", a: 'd2-cms-count-max', v: 'liczba', el: 'input d2-cms-count', d: 'Górny limit wartości.' },
      { g: "Doładowywanie i liczba widocznych", a: 'd2-cms-count-step', v: '1 | -1 | n', el: 'Button', d: 'Zwiększa / zmniejsza liczbę widocznych itemów (puste = 1).' },
      { g: "Przełącznik ukryj / pokaż", a: 'd2-cms-toggle', v: 'pole:wartość', el: 'Button', d: 'Przełącznik ukryj/pokaż dla itemów z tą wartością (filtr wykluczający).' },
      { g: "Przełącznik ukryj / pokaż", a: 'd2-cms-toggle-hide', v: 'tekst', el: 'przycisk toggle', d: 'Etykieta, gdy itemy są widoczne (opisuje następną akcję: „Ukryj…”).' },
      { g: "Przełącznik ukryj / pokaż", a: 'd2-cms-toggle-show', v: 'tekst', el: 'przycisk toggle', d: 'Etykieta, gdy itemy są ukryte („Pokaż…”).' },
      { g: "Przełącznik ukryj / pokaż", a: 'd2-cms-toggle-default', v: 'hidden', el: 'przycisk toggle', d: 'Startuje z aktywnym ukryciem (np. sprzedane schowane od wejścia).' },
      { g: "Przełącznik ukryj / pokaż", a: 'd2-cms-toggle-active', v: '', el: 'przycisk toggle', set: true, d: 'Obecny, gdy ukrycie aktywne — hook do stylowania.' },
      { g: "Liczniki i brak wyników", a: 'd2-cms-empty', v: '', el: 'Div', d: 'Pokazywany, gdy filtry nie zwracają żadnego itemu (w Designerze daj Display: none).' },
      { g: "Liczniki i brak wyników", a: 'd2-cms-display', v: 'visible | matching | total | hidden | remaining', el: 'Text', d: 'Moduł wpisuje tu licznik: widoczne / pasujące / wszystkie / ukryte / pozostałe.' },
      { g: "Liczniki i brak wyników", a: 'd2-cms-display-format', v: 'np. {visible} z {matching}', el: 'Text', d: 'Własny format licznika z tokenami w klamrach.' }
    ],
  ...
  forms: {
    ...
    attrs: [
      ...
      { a: 'd2-form-reset', v: 'sekundy (puste = 30)', el: 'wrapper .w-form', d: 'Po sukcesie Webflow chowa <code>&lt;form&gt;</code> i zostawia „Dziękujemy” aż do przeładowania. Ten atrybut przywraca pusty formularz po N sekundach — dla wszystkiego, co wysyła się częściej niż raz.', n: 'wartości ukrytych pól (UTM_*, GCLID, IP_ADDRESS) przeżywają reset; przy <b>błędzie</b> znika sam komunikat, a wpisane dane zostają' },
  ...
  popups: {
    ...
    attrs: [
      ...
      { a: 'd2-popup-utm', v: 'klucz:wartość|wartość', el: 'overlay popupu', d: 'Pokazuj tylko ruchowi z danej kampanii, np. <code>utm_source:facebook|instagram</code>. Sam klucz albo <code>*</code> = dowolna niepusta wartość. Dopasowanie dokładne, bez względu na wielkość liter. Klucz to dowolny parametr URL — <code>ref:partner-a</code> też zadziała.', n: 'wartość pamiętana w cookie od wejścia, więc bramka działa też na kolejnych podstronach; <code>utmCookie: false</code> wyłącza zapis' },
      { a: 'd2-popup-utm-exclude', v: 'klucz:wartość|wartość', el: 'overlay popupu', d: 'Nigdy nie pokazuj temu ruchowi, np. <code>utm_medium:cpc</code>. Wyklucznie wygrywa z <code>d2-popup-utm</code>.' }
    ],
    ...
    api: {
      ...
      code: "digi2.onReady(function () {\n  digi2.popups.create('newsletter', {\n    popupSelector: '#newsletter-popup',\n    closeTriggerSelector: '.popup__close',\n    animation: 'slide-up',\n    animationDuration: 0.4,\n    lockScrollOnShow: true,\n\n    // wyzwalacze (dowolna kombinacja)\n    openAfterDelay: 5,             // sekundy od wejścia\n    openOnExitIntent: false,       // desktop: mysz poza okno, mobile: szybki scroll w górę\n    openAfterScrollPercent: null,  // 0–100\n    openAfterScrollPastElement: null, // '#cennik'\n    openAfterIdle: null,           // sekundy bezczynności\n    openAfterPageViews: null,      // po N odsłonach w sesji\n    openOnRageClick: null,         // true lub liczba klików\n    interceptLinks: false,         // true | selektor | { device, selector }\n\n    // pokazywanie\n    cookieName: 'nl_seen',         // null = pokazuj zawsze\n    cookieDurationDays: 7,\n    setCookieOnClose: true,        // false → zamknięcie NIE wycisza popupu\n                                   // (wraca, aż wywołasz markSeen())\n    schedule: { from: '2026-07-01 00:00', to: '2026-07-31 23:59' },\n    excludeUrls: ['/kontakt'],\n\n    // kierowanie na ruch (albo atrybutami d2-popup-utm / -utm-exclude)\n    utm: 'utm_source:facebook|instagram',  // tylko ten ruch\n    utmExclude: 'utm_medium:cpc',          // nigdy ten ruch\n    utmCookie: true,                       // zapamiętaj kampanię na kolejne podstrony\n    utmCookieDays: 365,\n\n    onOpen: function () {},\n    onClose: function () {}\n  });\n\n  // ── Sekwencja dwóch popupów + wideo w środku ──\n  var welcome = digi2.popups.create('welcome', {\n    popupSelector: '#popup-welcome',\n    cookieName: 'popup_welcome_closed',\n    cookieDurationDays: 1,\n    openOnLoad: true,\n    onClose: function () { video.showIfPending(); }\n  });\n\n  var video = digi2.popups.create('video', {\n    popupSelector: '#popup-video',\n    cookieName: 'popup_video_watched',\n    cookieDurationDays: 1,\n    openAfterDelay: 30,\n    canShow: function () { return !welcome.isVisible; }, // odłóż, gdy tamten otwarty\n    video: {\n      cookieOnEnd: true,   // UWAGA: włącza setCookieOnClose:false —\n                           // cookie leci dopiero po OBEJRZENIU filmu do końca,\n                           // samo zamknięcie NIE wycisza popupu\n      closeOnEnd: true\n    }\n  });\n\n  // Chcesz „raz na dobę niezależnie od obejrzenia\"? Dopisz jawnie:\n  //   setCookieOnClose: true\n});\n\n// ── Jeden popup kilka razy w trakcie wizyty ──\n// Liczby to sekundy: pierwsza od wejścia, każda kolejna od ZAMKNIĘCIA\n// poprzedniego pokazu. afterPageChange = czekaj na inną podstronę\n// i dopiero tam zacznij odliczać.\ndigi2.popups.create('promo', {\n  popupSelector: '#popup-promo',\n  cookieName: null,               // ma wracać do nowych i powracających\n  sequence: [4, { after: 60, afterPageChange: true }, 180, 180]\n});\n// Sam ustawia setCookieOnClose:false — popup, który ma wracać, nie może\n// traktować zamknięcia jako „widziałem\", bo kolejne pokazy zostałyby pominięte.\n\n// ── Łańcuch RÓŻNYCH popupów przez całą wizytę ──\ndigi2.popups.sequence([\n  { popup: 'welcome',    after: 4 },\n  { popup: 'oferta',     after: 60, afterPageChange: true },\n  { popup: 'newsletter', after: 180 }\n]);\n// Zegar stoi, gdy karta jest w tle; stan przeżywa przejścia między\n// podstronami (sessionStorage), a nowa sesja startuje łańcuch od nowa.\n// Krok, którego popup nie pasuje do ruchu (utm), jest pomijany — inaczej\n// łańcuch stałby w tym miejscu do końca wizyty.\n// Krok czeka też, gdy inny popup jest otwarty: zaplanowany popup nie\n// wchodzi na formularz, który odwiedzający sam otworzył.\n\n// ── Zasada: jeden popup naraz ──\n// Popup otwarty automatycznie (openAfterDelay, exit intent, scroll,\n// bezczynność, krok sekwencji) NIE zasłania i NIE zamyka tego, co jest\n// na ekranie — czeka i wchodzi ~0,6 s po zwolnieniu ekranu. Popup otwarty\n// świadomie przez odwiedzającego (d2-show-popup, openTriggerSelector,\n// digi2.popups.show()) ma pierwszeństwo: to, co jest na ekranie, zamyka się\n// pierwsze, a nowy popup wchodzi dopiero po tym zamknięciu.\n// Odłożony popup przy swojej kolejce sprawdza wszystko od nowa (cookie,\n// harmonogram, canShow) — czeka na wolny ekran, nie na gwarantowany pokaz.\n// Blokada scrolla strony jest liczona — zdejmuje ją ostatni zamykany popup,\n// niezależnie od tego, czy przeglądarka zgłosi koniec animacji."
    },

    examples: [
      { title: 'Popup tylko dla ruchu z kampanii', desc: 'Bramka na źródło ruchu: popup zobaczy wyłącznie ktoś, kto przyszedł z Facebooka lub Instagrama — także na trzeciej podstronie, bo kampania zapamiętywana jest w cookie od wejścia.', code: '<!-- overlay popupu -->\n<div id="promo-fb" d2-popup-utm="utm_source:facebook|instagram">…</div>\n\n<!-- odwrotnie: nigdy dla ruchu płatnego -->\n<div id="promo-organic" d2-popup-utm-exclude="utm_medium:cpc">…</div>' },
